export const PageRoutes = {
  ...
  ADMIN_NEWSPAPERS: "/admin/newspapers",
  ADMIN_NEWSPAPERS_SEGMENT: "newspapers",
...
export const ApiRoutes = {
  ...
  ADMIN_NEWSPAPERS: "/api/admin/newspapers",
  ADMIN_NEWSPAPER_BY_ID: "/api/admin/newspapers/:id",
  ADMIN_NEWSPAPERS_UPLOAD: "/api/admin/newspapers/upload",
